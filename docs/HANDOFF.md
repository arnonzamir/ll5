...
- **Agent nudge scheduler**: if no journal entry in 60 minutes during active hours, sends `[Agent Nudge]` with proactivity checklist (inbox, ticklers, escalations, push opportunities). Replaces old journal health check.
