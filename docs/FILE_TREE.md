...
│   └── docker-compose.prod.yml       # **Production source of truth** (10 services; dashboard at ll5.noninoni.click). CI scp's to host on every deploy; never edit on host.
│
├── docs/
