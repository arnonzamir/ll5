...
│       ├── app/(user)/                # dashboard, calendar (timeline day/week views +settings +ticklers), actions, projects, inbox, shopping, people, locations, places, media, health, phone-data, sessions, settings (contacts [3 tabs: people/contacts/groups], notifications, messaging, health, notification-levels, scheduler), profile
