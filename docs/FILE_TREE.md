...
│       ├── tools/                     # 18 tools — calendar (CRUD, sync, availability, tickler), Gmail, OAuth
...
│       ├── app/(user)/                # dashboard, calendar, actions, projects, inbox, shopping, people (grouped filter), locations, places, phone-data, settings, profile
