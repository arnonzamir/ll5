...
| ISS-009 | scaffolding | med | Two divergent narrative-freshness policies; two copies of the reconcile selector + gate | fixed | reconcile half: both copies retired, DECISION-028 #1/#3 (2026-09-04, commit `refactor(scaffolding): retire the reconcile subsystem (DECISION-028 #1)`); narrative-policy half is DECISION-028 #2, handled by another track |
