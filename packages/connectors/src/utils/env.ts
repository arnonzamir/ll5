export interface EnvConfig {
  ...
  apiKey?: string;
  userId?: string;
  /** Only for the audit ledger + app log (initAudit / initAppLog) — no ES client here. */
...
export function loadEnv(): EnvConfig {
  ...
  if (!elasticsearchUrl) {
    throw new Error('ELASTICSEARCH_URL environment variable is required (audit ledger + app log)');
  }
